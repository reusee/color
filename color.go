...
var (
	...
	Green              = color.RGBA{n1, 0xff, n1, 0}
	LightGreen         = color.RGBA{n2, 0xff, n2, 0}
	Yellow             = color.RGBA{0xff, 0xff, n1, 0}
	LightYellow        = color.RGBA{0xff, 0xff, n2, 0}
	Blue               = color.RGBA{n1, n1, 0xff, 0}
	LightBlue          = color.RGBA{n2, n2, 0xff, 0}
	Magenta            = color.RGBA{0xff, n1, 0xff, 0}
	LightMagenta       = color.RGBA{0xff, n2, 0xff, 0}
	Cyan               = color.RGBA{n1, 0xff, 0xff, 0}
	LightCyan          = color.RGBA{n2, 0xff, 0xff, 0}
