...
var (
	...
	Black        = color.RGBA{0x44, 0x44, 0x44, 0}
	LightBlack   = color.RGBA{0x55, 0x55, 0x55, 0}
	Red          = color.RGBA{0xff, 0xe0, 0xe0, 0}
	LightRed     = color.RGBA{0xff, 0xee, 0xee, 0}
	Green        = color.RGBA{0xcc, 0xff, 0xcc, 0}
	LightGreen   = color.RGBA{0xdd, 0xff, 0xdd, 0}
	Yellow       = color.RGBA{0xff, 0xff, 0xcc, 0}
	LightYellow  = color.RGBA{0xff, 0xff, 0xdd, 0}
	Blue         = color.RGBA{0xe8, 0xe8, 0xff, 0}
	LightBlue    = color.RGBA{0xf0, 0xf0, 0xff, 0}
	Magenta      = color.RGBA{0xff, 0xcc, 0xff, 0}
	LightMagenta = color.RGBA{0xff, 0xdd, 0xff, 0}
	Cyan         = color.RGBA{0xcc, 0xff, 0xff, 0}
	LightCyan    = color.RGBA{0xdd, 0xff, 0xff, 0}
